...
function buildWatchDescription(movie: Movie, episodeName?: string | null) {
  ...
  const metaBits = [
    ...
    .filter(Boolean)
    .join(", ");
  const prefix = `Xem phim ${movie.name}${episodeText}${metaBits ? ` ${metaBits}` : ""} tại Phimhayz.site.`;
    ...
    <div className="min-h-screen bg-[#040714] pb-20 pt-24">
      ...
      <div className="container mx-auto space-y-8 px-4">
        ...
        <div className="rounded-xl border border-white/5 bg-[#1e293b]/50 p-6 backdrop-blur-sm">
          ...
          <p className="line-clamp-3 cursor-pointer text-sm leading-relaxed text-gray-300 transition-all hover:line-clamp-none">
        ...
        <div className="flex flex-col gap-8 lg:flex-row">
          ...
          <div className="shrink-0 space-y-8 lg:w-72 xl:w-80">
            {movie.actor ? <CastList actors={movie.actor} /> : null}
            {trendingData?.items ? (
