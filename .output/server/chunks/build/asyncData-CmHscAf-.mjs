globalThis.__timing__.logStart('Load chunks/build/asyncData-CmHscAf-');import { computed, toValue, getCurrentInstance, onServerPrefetch, defineComponent, shallowRef, provide, cloneVNode, h, createElementBlock, ref, nextTick, unref, toRef } from 'vue';
import { b as useNuxtApp, e as asyncDataDefaults, c as createError } from './server.mjs';
...
export { __nuxt_component_0 as _, useAsyncData as u };;globalThis.__timing__.logEnd('Load chunks/build/asyncData-CmHscAf-');
//# sourceMappingURL=asyncData-CmHscAf-.mjs.map
