globalThis.__timing__.logStart('Load chunks/build/default-CkR8ANbf');import { _ as __nuxt_component_0 } from './nuxt-link-2k-Xgjf3.mjs';
import { c as cn } from './cn-H80jjgLf.mjs';
import { mergeProps, defineComponent, ref, watch, unref, withCtx, createVNode, createTextVNode, toDisplayString, useSSRContext } from 'vue';
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const navLinks = [
      ...
      { name: "Ho\u1EA1t h\xECnh", href: "/danh-sach/hoat-hinh" },
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<input${ssrRenderAttr("value", unref(searchQuery))} autofocus class="ml-3 w-full border-none bg-transparent text-base text-white focus:outline-none" placeholder="T\xECm ki\u1EBFm phim..." type="text"></form></div><button class="${ssrRenderClass(
        ("cn" in _ctx ? _ctx.cn : unref(cn))(
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<p class="mt-4 max-w-xs text-sm leading-relaxed text-gray-400"> Kho phim online c\u1EADp nh\u1EADt nhanh, giao di\u1EC7n g\u1ECDn g\xE0ng v\xE0 tr\u1EA3i nghi\u1EC7m xem phim m\u01B0\u1EE3t tr\xEAn c\u1EA3 \u0111i\u1EC7n tho\u1EA1i l\u1EABn m\xE1y t\xEDnh. </p></div><div><h4 class="mb-6 font-semibold text-white">Kh\xE1m ph\xE1</h4><ul class="space-y-3"><li>`);
  _push(ssrRenderComponent(_component_NuxtLink, {
...
export { _default as default };;globalThis.__timing__.logEnd('Load chunks/build/default-CkR8ANbf');
//# sourceMappingURL=default-CkR8ANbf.mjs.map
