  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.episodes.length) {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "rounded-xl border border-white/5 bg-card-dark p-6" }, _attrs))}><h3 class="mb-4 flex items-center gap-2 text-xl font-bold text-white"><span class="h-6 w-1 rounded-full bg-primary"></span> Danh sách tập </h3><div class="mb-6 flex flex-wrap gap-2"><!--[-->`);
        ...
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "rounded-xl border border-white/5 bg-card-dark p-6 text-sm text-gray-400" }, _attrs))}> Không có tập phim nào. </div>`);
      }
    };
  }
});
...
//# sourceMappingURL=EpisodeGroup-BXXTDdMG.js.map
