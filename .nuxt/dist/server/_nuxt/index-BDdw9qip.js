...
import { defineComponent, ref, mergeProps, unref, withCtx, createVNode, useSSRContext, withAsyncContext } from "vue";
...
import { a as useSeoMeta } from "./v3-m4Jfmifc.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.movies.length) {
        ...
        ssrRenderList(__props.movies, (movie, index) => {
          ...
          _push(` IMDb ${ssrInterpolate(typeof movie.imdb === "object" ? movie.imdb?.vote_average || "N/A" : "N/A")}</span><span class="flex items-center gap-1 rounded bg-white/10 px-2 py-0.5">`);
          ...
          _push(`<span>Thêm vào DS</span></button>`);
          _push(ssrRenderComponent(_component_NuxtLink, {
            to: `/phim/${movie.slug}`,
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(hoatHinh)?.items?.length) {
        _push(ssrRenderComponent(_component_MovieGrid, {
...
//# sourceMappingURL=index-BDdw9qip.js.map
