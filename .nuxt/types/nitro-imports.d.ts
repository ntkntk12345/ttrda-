declare global {
  ...
  const SESSION_SECRET: typeof import('../../server/utils/admin/credentials').SESSION_SECRET
  ...
  const clearAdminSession: typeof import('../../server/utils/admin/session').clearAdminSession
  ...
  const createScript: typeof import('../../server/utils/admin/scripts-store').createScript
  ...
  const deleteScript: typeof import('../../server/utils/admin/scripts-store').deleteScript
  ...
  const getActiveScripts: typeof import('../../server/utils/admin/scripts-store').getActiveScripts
  const getAdminSession: typeof import('../../server/utils/admin/session').getAdminSession
  const getAllScripts: typeof import('../../server/utils/admin/scripts-store').getAllScripts
  ...
  const isAdminAuthenticated: typeof import('../../server/utils/admin/session').isAdminAuthenticated
  ...
  const parseScriptInput: typeof import('../../server/utils/admin/scripts-store').parseScriptInput
  ...
  const updateScript: typeof import('../../server/utils/admin/scripts-store').updateScript
  ...
  const verifyAdminCredentials: typeof import('../../server/utils/admin/credentials').verifyAdminCredentials
...
declare global {
  ...
  // @ts-ignore
  export type { ScriptInput } from '../../server/utils/admin/scripts-store'
  import('../../server/utils/admin/scripts-store')
}
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from 'C:/Users/trong/Downloads/ttrda-/ttrda-/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths';
export { defineAppConfig } from 'C:/Users/trong/Downloads/ttrda-/ttrda-/node_modules/@nuxt/nitro-server/dist/runtime/utils/config';
export { SESSION_SECRET, verifyAdminCredentials } from 'C:/Users/trong/Downloads/ttrda-/ttrda-/server/utils/admin/credentials';
export { parseScriptInput, getAllScripts, getActiveScripts, createScript, updateScript, deleteScript } from 'C:/Users/trong/Downloads/ttrda-/ttrda-/server/utils/admin/scripts-store';
export { createAdminSession, clearAdminSession, getAdminSession, isAdminAuthenticated } from 'C:/Users/trong/Downloads/ttrda-/ttrda-/server/utils/admin/session';