...
export {}
declare global {
  const CATEGORY_TITLES: typeof import('../../src/utils/movie-taxonomy').CATEGORY_TITLES
  const FILTER_CATEGORIES: typeof import('../../src/utils/movie-taxonomy').FILTER_CATEGORIES
  const FILTER_COUNTRIES: typeof import('../../src/utils/movie-taxonomy').FILTER_COUNTRIES
  const FILTER_SORTS: typeof import('../../src/utils/movie-taxonomy').FILTER_SORTS
  const FILTER_TYPES: typeof import('../../src/utils/movie-taxonomy').FILTER_TYPES
  const FILTER_YEARS: typeof import('../../src/utils/movie-taxonomy').FILTER_YEARS
  const OPhimUtils: typeof import('../../src/utils/ophim').OPhimUtils
  const OphimService: typeof import('../../src/utils/ophim-service').OphimService
  ...
  const cn: typeof import('../../src/utils/cn').cn
...
declare module 'vue' {
  interface ComponentCustomProperties {
    readonly CATEGORY_TITLES: UnwrapRef<typeof import('../../src/utils/movie-taxonomy')['CATEGORY_TITLES']>
    readonly FILTER_CATEGORIES: UnwrapRef<typeof import('../../src/utils/movie-taxonomy')['FILTER_CATEGORIES']>
    readonly FILTER_COUNTRIES: UnwrapRef<typeof import('../../src/utils/movie-taxonomy')['FILTER_COUNTRIES']>
    readonly FILTER_SORTS: UnwrapRef<typeof import('../../src/utils/movie-taxonomy')['FILTER_SORTS']>
    readonly FILTER_TYPES: UnwrapRef<typeof import('../../src/utils/movie-taxonomy')['FILTER_TYPES']>
    readonly FILTER_YEARS: UnwrapRef<typeof import('../../src/utils/movie-taxonomy')['FILTER_YEARS']>
    readonly OPhimUtils: UnwrapRef<typeof import('../../src/utils/ophim')['OPhimUtils']>
    readonly OphimService: UnwrapRef<typeof import('../../src/utils/ophim-service')['OphimService']>
    ...
    readonly cn: UnwrapRef<typeof import('../../src/utils/cn')['cn']>
